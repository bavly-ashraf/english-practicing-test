    ...
    return ( 
        ...
        <div className="container">
            ...
            <div className="row justify-content-center m-5">
                ...
                <img className='w-25' src={rank >= 90? "../assets/Images/gold-medal-svgrepo-com.svg": rank<50? "../assets/Images/football-field-svgrepo-com.svg": rank >= 50 && rank< 75? "../assets/Images/bronze-medal-svgrepo-com.svg" : "../assets/Images/silver-medal-svgrepo-com.svg"} alt='rank status' />
            </div>
            <div className="row">
